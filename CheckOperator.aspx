<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckOperator.aspx.cs" Inherits="CheckOperator" %>
        ...
        <div class="mainbody">
            <div id="main" runat="server" Visible="true">
                ...
                <div class="BanglaMovie" style="margin-top:45%">
                    ...
                    <div>
                        ...
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="images/6.png"  Width="100%"></asp:ImageButton>
              ...
              <%--  <div class="BanglaMovie" style="margin-top:0%">
                   ...
                   <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="images/na.png" Width="50%"></asp:ImageButton>
            ...
            <%--    <div class="BanglaMovie">
                    ...
                    <div class="text-center">
                        ...
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="Images/nna.png" Width="50%"></asp:ImageButton>
            ...
            <div class="BanglaMovie">
                ...
                <div class="text-center">
                    ...
                    <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="images/home.jpg" PostBackUrl="~/Default.aspx" Width="50%"></asp:ImageButton>
