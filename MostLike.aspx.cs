...
public partial class MostLike : System.Web.UI.Page
{
    CDA CA = new CDA();
    DataSet ds = null;
    ...
    {
        ds = CA.GetDataSet("Exec [FitnessPortal].dbo.[Sp_getContentsMostLiked_fitness] 'E0AEF450-099B-495F-B056-8AED4B95F00A', 6", "WAPDB");
    ...
    protected void btnLikeMore_Click(object sender, ImageClickEventArgs e)
    {
        ...
        dscount = CA.GetDataSet("Exec FitnessPortal.dbo.[Sp_getContentsMostLiked_fitness] 'A2106AB1-A41B-41C4-96FC-42971B8F84C5', " + 25000 + "", "WAPDB");
        ...
        ds = CA.GetDataSet("Exec FitnessPortal.dbo.[Sp_getContentsMostLiked_fitness] 'A2106AB1-A41B-41C4-96FC-42971B8F84C5', " + Session["mostLike"] + "", "WAPDB");
