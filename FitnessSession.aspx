<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FitnessSession.aspx.cs" Inherits="FitnessSession" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="Wrap" id="Wrapid" style="display: block">
            ...
            <div class="mainbody">
                ...
                <div class="container">
                    <div class="row">
                        <asp:Repeater ID="repeaterZumba" runat="server">
                            <ItemTemplate>
                        ...
                        <div class="col-xs-offset-9 col-xs-4">
                            <asp:ImageButton runat="server" CssClass="moreBu1" PostBackUrl="~/MoreFitnessSession.aspx?type=zumba" ImageUrl="images/more.png" />
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <asp:Repeater ID="repeaterYoga" runat="server">
                                <ItemTemplate>
                                    <div class="col-lg-6 col-md-6 col-xs-6" style="padding-left: 2px; padding-right: 2px; padding-top: -5px; padding-bottom: -25px;">
                                        <asp:HyperLink ID="vdoPic" runat="server" CssClass="thumbnail img-responsive" NavigateUrl='<%# Eval("path")%>' ImageUrl='<%# Bind("imageUrl") %>' />
                                    </div>
                              ...
                              <div class="col-xs-offset-9 col-xs-4">
                            <asp:ImageButton runat="server" CssClass="moreBu1" PostBackUrl="~/MoreFitnessSession.aspx?type=yoga" ImageUrl="images/more.png" />
                 ...
                 <%-- EasyWorkOut Session Start--%>
                    ...
                    <div class="container">
                        <div class="row">
                            <asp:Repeater ID="repeaterEasyWorkOut" runat="server">
                                <ItemTemplate>
                                    <div class="col-lg-6 col-md-6 col-xs-6" style="padding-left: 2px; padding-right: 2px; padding-top: -5px; padding-bottom: -25px;">
                                        <asp:HyperLink ID="vdoPic" runat="server" CssClass="thumbnail img-responsive" NavigateUrl='<%# Eval("path")%>' ImageUrl='<%# Bind("imageUrl") %>' />
                                    </div>
                              ...
                              <div class="col-xs-offset-9 col-xs-4">
                            <asp:ImageButton runat="server" CssClass="moreBu1" PostBackUrl="~/MoreFitnessSession.aspx?type=easy" ImageUrl="images/more.png" />
