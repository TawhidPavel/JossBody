<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nibondhon.aspx.cs" Inherits="Nibondhon" %>
        ...
        <div id="main" runat="server" Visible="true">
            ...
            <div class="BanglaMovie" style="margin-top:45%">
                ...
                <div>
                    ...
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="Images/1text.png"  Width="100%"></asp:ImageButton>
            ...
            <div class="BanglaMovie" style="margin-top:0%">
                ...
                <div class="text-center">
                    ...
                    <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="images/suru.jpg"  Width="50%" PostBackUrl="Default.aspx"></asp:ImageButton>
