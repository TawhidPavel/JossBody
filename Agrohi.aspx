<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Agrohi.aspx.cs" Inherits="Agrohi" %>
            ...
            <div id="main" runat="server" Visible="true">
                ...
                <div class="BanglaMovie" style="margin-top:45%">
                    ...
                    <div>
                        ...
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="Images/agrohi.png"  Width="100%"></asp:ImageButton>
                ...
                <div class="BanglaMovie" style="margin-top:0%">
                    ...
                    <div class="text-center">
                        ...
                        <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="images/agrohi.jpg" OnClick="btnAdd_OnClick"  Width="70%"></asp:ImageButton>
