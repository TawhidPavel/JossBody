<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MostLike.aspx.cs" Inherits="MostLike" %>
            ...
            <div class="section">
              ...
              <%--  One Row--%>
                              ...
                              <div class="section1">
                                  ...
                                  <span class="slide-title">
                                      ...
                                      <div class="col-xs-5 col-sm-4">
                                          <img src="images/vi.png" style="width: 16px;height: 17px; margin-left: 8px"><%# Eval("totalView") %></div>
                                  </span>
                ...
                <div class="horzontalineimg">
                        <asp:ImageButton ID="imgButtonMore" ImageUrl="~/images/more.png" CssClass="btnde" Width="25%" OnClick="btnLikeMore_Click" runat="server" />
